...
const GitUploadModal = ({ isOpen, onClose, onSubmit, isSubmitting }) => {
  ...
  const selectedRepo = useWatch({ control, name: 'repository' });
  ...
  return (
    ...
    >
      ...
      <form className="git-upload-modal__content" onSubmit={handleSubmit(submit)}>
              ...
              render={({ field }) => (
                <ReviewDropdown
                  ...
                  onChange={(value) => {
                    ...
                    setValue('pullRequest', '', { shouldDirty: true, shouldValidate: true });
                  }}
        ...
        <div className="git-upload-modal__footer">
          <button type="submit" className="git-upload-modal__submit-btn" disabled={isSubmitDisabled()}>
