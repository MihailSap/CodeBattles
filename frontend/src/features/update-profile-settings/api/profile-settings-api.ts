...
export const profileSettingsApi = {
  async updatePassword(currentPassword: LegacyValue, newPassword: LegacyValue) {
  ...
  async updateNotificationSettings(settings: LegacyValue) {
