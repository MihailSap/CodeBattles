...
export const ACHIEVEMENTS = [
  ...
  { id: 4, image: legendaRevyuImage, name: 'Легенда ревью', description: 'Завершить 100 ревью', visible: true },
  {
    ...
    name: 'Влюблён в ИИ',
    description: 'Завершить 10 задач только с AI-проверкой',
    visible: true,
  },
  {
    id: 6,
    image: pochtiYandexImage,
    name: 'Почти Яндекс',
    description: 'Создать 10 проектов в одной организации',
    visible: true,
  },
  {
    id: 7,
    image: sonDlyaSlabykhImage,
    name: 'Сон для слабых',
    description: 'Закрыть задачу в промежутке 00:00-06:00',
    visible: true,
  },
  {
    id: 8,
    image: bespodobnyImage,
    name: 'Бесподобный',
    description: 'Получить суммарную оценку 5 от всех ревьюверов',
    visible: true,
  },
  {
    id: 9,
    image: vosstanieMashinnImage,
    name: 'Восстание машин',
    description: 'Получить от AI-ревьювера оценку 1 балл по любому критерию',
    visible: true,
  },
  {
    id: 10,
    image: zhestokiyMirImage,
    name: 'Жестокий мир',
    description: 'Получить среднюю оценку ревью ниже 3',
    visible: false,
  },
  {
    id: 11,
    image: nelzyaSdatImage,
    name: 'Нельзя сдать пятьсот миллионов задач, не получив ни одного плохого отзыва',
    description: 'Получить оценку 1 или 2 за любой критерий',
    visible: false,
  },
  {
    id: 12,
    image: krikTishinyImage,
    name: 'Крик тишины',
