            ...
            children: [
              {
                ...
                name: 'Layout.jsx',
                isDirectory: false,
                content: 'export const Layout = ({ children }: LegacyValue) => <div>{children}</div>;',
              },
              {
...
export const ArchitectureDiagram = ({ configId, initialZoom = 1 }: LegacyValue) => {
  ...
  const [selectedNode, setSelectedNode] = useState<LegacyValue>(null);
