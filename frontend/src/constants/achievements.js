import baseAchievementImage from '../assets/achievement-nachalo-nachal-icon.svg';
...
export const ACHIEVEMENTS = [
  ...
  { id: 9, image: baseAchievementImage, name: 'Восстание машин', description: 'Получить от AI-ревьювера оценку 1 балл по любому критерию', visible: true },
  { id: 10, image: baseAchievementImage, name: 'Жестокий мир', description: 'Получить среднюю оценку ревью ниже 3', visible: false },
  { id: 11, image: baseAchievementImage, name: 'Нельзя сдать пятьсот миллионов задач, не получив ни одного плохого отзыва', description: 'Получить оценку 1 или 2 за любой критерий', visible: false },
  { id: 12, image: baseAchievementImage, name: 'Крик тишины', description: 'Отправить ревью без inline-комментария', visible: false },
  { id: 13, image: baseAchievementImage, name: 'Дело храбрых', description: 'Отправить жалобу на ревью', visible: false },
  { id: 14, image: baseAchievementImage, name: 'Опытный юзер', description: 'Набрать 500 баллов', visible: true },
  { id: 15, image: baseAchievementImage, name: 'Пора бы в отпуск…', description: 'Набрать 5000 баллов', visible: true },
  { id: 16, image: baseAchievementImage, name: 'Сколько? Сколько?', description: 'Набрать 10000 баллов', visible: true },
  { id: 17, image: baseAchievementImage, name: 'Неловко вышло…', description: 'Получить отрицательное количество баллов', visible: false },
  { id: 18, image: baseAchievementImage, name: 'Звук свободы', description: 'Не сдать задачу вовремя', visible: false }
];
