import { TASK_STATUS, TASK_REVIEW_TYPE } from '../../constants/project';
...
export const MOCK_TASKS = [
  {
    ...
    description: 'Нужно настроить главную страницу, страницу ошибки 404 и ленивую загрузку компонентов. Приложение должно корректно обрабатывать недопустимые URL.',
    requirements: '1. Использовать createBrowserRouter из react-router-dom v6.\n2. Реализовать Suspense для lazy components.\n3. Покрытие тестами не менее 80%.',
  ...
  },
  {
    ...
    description: 'Интегрировать базовые CSS-переменные, собрать компоненты кнопок и инпутов. Настроить темы (Dark/Light).',
  ...
  },
  {
    ...
    description: 'Разработать сложный компонент для отображения графа архитектуры с возможностью зума, панорамирования и перемещения узлов графа.',
    requirements: '1. Никаких D3 или cytoscape, только React + SVG.\n2. Оптимизация производительности для 1000+ узлов.\n3. Использование Redux для хранения координат.',
    evaluationCriteria: '1. Плавно зумится (60 FPS).\n2. Узлы перетаскиваются без лагов.\n3. Корректное обновление стейта в Redux.',
  ...
  },
  {
    ...
    description: 'Разработать Redux middleware для обработки JWT токенов, автоматического refresh-запроса и редиректа при 401 ошибке.',
    requirements: '1. Использовать Axios Interceptors.\n2. Обрабатывать гонку запросов (race conditions) при обновлении токена.\n3. Сохранять access токен в памяти, refresh - в httpOnly cookie.',
  ...
  },
  {
    ...
    description: 'Настроить GitHub Actions для сборки Vite приложения, запуска тестов, проверки линтера и деплоя на Vercel.',
