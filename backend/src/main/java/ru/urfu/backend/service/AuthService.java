...
public interface AuthService {
    ...
    User register(RegisterRequest request) throws UserAlreadyExistsException;
    ...
    JwtResponse verifyEmail(String token) throws UserNotFoundException, AuthException;
    ...
    void resetPassword(PasswordResetRequest request) throws UserNotFoundException;
}
